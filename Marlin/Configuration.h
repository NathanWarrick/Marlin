...
#define STRING_CONFIG_H_AUTHOR "(Nathan, Albert-Alternate_Motors)" // Who made the changes.
...
#define HOMING_FEEDRATE_X (6000)
#define HOMING_FEEDRATE_Y (6000)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT ((X_BED_SIZE) / 2)    // (mm) Y point for Z homing
